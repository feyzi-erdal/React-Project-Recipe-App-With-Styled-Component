...
// styled component in tercih edilmesinin sebeplerinin en basinda, props gönderilme ihtimali ve div gibi isimler degil de kendi tercih ettigimiz isimleri verebilmemizdir
...
background: #e1f1dd;
  ...
  @media (max-width: 768px) {
    overflow: hidden;
    /* uzun yazı olur da taşarsa gizle */
    flex-direction: column;
    width: 100%;
    /* gap:2px; */
    /* props olarak, osman=true geldi mesela */
    max-height: ${({isOpen}) => (isOpen) ? "300px" : "0px"};
    // burada {} icinde isOpen i aldik direkt icine girmis olduk
